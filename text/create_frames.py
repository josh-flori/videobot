...
def create_frames(parameters,num_lines,exceeds_limit,user,age,age_type,updoots,comment_num,directory):
    ...
    # add user
    d.text((100,505-(num_lines*28.5)), user, font=fnt1, fill=(42, 175, 247))
    # add points
    ...
    for i in range(len(parameters)):
        ...
        img.save(directory+'/'+str(comment_num)+str(i)+'.png')
        image_paths.append(directory+'/'+str(comment_num)+str(i)+'.png')
