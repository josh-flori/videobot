...
def create_video(image_paths,parameters,audio_file,comment_num,directory):
    ...
    concat_clip.write_videofile(directory+"/"+str(comment_num)+".mp4", fps=5,audio=directory+audio_file)
