...
def create_video(image_paths,parameters,audio_path,comment_num,directory):
    ...
    concat_clip.write_videofile(directory+"/"+str(comment_num)+".mp4", fps=5,audio=audio_path)
